...
-- ----------------------------
INSERT INTO `book_info` VALUES (1, '大雪中的山庄', '东野圭吾 ', '北京十月文艺出版社', '9787530216835', '东野圭吾长篇小说杰作，中文简体首次出版。 一出没有剧本的舞台剧，为什么能让七个演员赌上全部人生.东野圭吾就是有这样过人的本领，能从充满悬念的案子写出荡气回肠的情感，在极其周密曲折的同时写出人性的黑暗与美丽。 一家与外界隔绝的民宿里，七个演员被要求住满四天，接受导演的考验，但不断有人失踪。难道这并非正常排练，而是有人布下陷阱要杀他们。 那时候我开始喜欢上戏剧和音乐，《大雪中的山庄》一书的灵感就来源于此。我相信这次的诡计肯定会让人大吃一惊。——东野圭吾', '中文', 30.00, '2022-03-01', 9, 1);
...
INSERT INTO `lend_list` VALUES (6, 6, 10000, '2017-06-15', '2023-07-07');
INSERT INTO `lend_list` VALUES (7, 1, 10001, '2017-09-02', '2017-09-02');
INSERT INTO `lend_list` VALUES (8, 6, 10000, '2023-07-07', NULL);
INSERT INTO `lend_list` VALUES (9, 1, 10000, '2023-07-07', NULL);
INSERT INTO `lend_list` VALUES (10, 8, 10001, '2023-07-08', '2023-07-08');
INSERT INTO `lend_list` VALUES (11, 5, 10001, '2023-07-08', '2023-07-08');
...
CREATE TABLE `reader_info`  (
  ...
  PRIMARY KEY (`reader_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 10006 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci ROW_FORMAT = Dynamic;
